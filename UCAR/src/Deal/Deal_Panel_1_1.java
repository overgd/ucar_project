...
public class Deal_Panel_1_1 extends TwoButton_Panel {
	
	
	String subject = "차종 검색";
	
	ButtonImage img;
	
	public Deal_Panel_1_1() {
		...
		base_center_visible(true, img.carquicklong_img_1, img.cardetailsearchlong_img_1);
